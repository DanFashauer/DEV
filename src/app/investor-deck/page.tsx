const slides = [
  ...
  },
  {
    ...
    talkTrack:
      'SignalGrid closes the loop before impact: no delayed triage, no unnecessary ticket churn, and no blind trust in unverified clients.',
  ...
  },
  {
    ...
    bullets: ['Platform engineering', 'Identity and access teams', 'Endpoint / shared-device program leaders'],
    talkTrack:
